...
3. Xoa chunks cu trong Qdrant theo source:
...
4. Upsert vao Qdrant collection.
...
1. Neu doi embedding mode/size, can doi collection Qdrant moi de tranh dimension mismatch.
