...
async def auth_context_middleware(request: Request, call_next):
    ...
    # Initialize request-scoped usage tracking context
    from .context import request_usage_var
    ctx_token = request_usage_var.set({"llm_calls": 0, "token_usage": 0})
    ...
    try:
        usage = request_usage_var.get() or {"llm_calls": 0, "token_usage": 0}
        ...
        request_usage_var.reset(ctx_token)
