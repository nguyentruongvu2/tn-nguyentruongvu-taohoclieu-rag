...
- **Backend:** FastAPI (Python), ChromaDB (Vector Search), Google Gemini 3 Flash (via LangChain/LiteLLM), python-pptx (Tạo Slide).
...
3. **Index** (`/documents/pipeline/index-markdown`): Nhúng (Embed) chunks vào ChromaDB.
